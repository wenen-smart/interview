...
public class ACTAirComboAttackState : IState<AttackType, AttackTransitionType, PlayerController>
{
    public ACTAirComboAttackState(AttackType stateType, FsmStateMachine<AttackType, AttackTransitionType, PlayerController> fsmStateMachine) : base(stateType, fsmStateMachine)
    {
    }
    ...
    {
        go.SedAttack("AirComboAttack");
        
        Debug.Log("AirComboAttackEnter");
    }
