...
public abstract class ResFactory<PrefabT,InstanceT>:CommonSingleTon<InstanceT>, IObjectFactory<PrefabT> where PrefabT : UnityEngine.Object,new() where InstanceT:new()
{
