...
public class AudioManager : MonoSingleTon<AudioManager>,IManager
{
    ...
    public void Init()
    {
        DebugTool.DebugPrint("Init AudioManager ...");
    }
    ...
    public void PlayAudioByClipClue(Transform caster,string identity,bool isFindChild)
    {
        AudioClipCue.Play(caster,identity,isFindChild);
    }
